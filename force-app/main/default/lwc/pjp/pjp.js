...
import getAccountData from '@salesforce/apex/PJPServiceImpl.getAccountList';
import getFilter1 from '@salesforce/apex/PJPServiceImpl.getFilterList1';
import saveAsDraft from '@salesforce/apex/PJPServiceImpl.saveAsDraft';
import { getPicklistValues } from 'lightning/uiObjectInfoApi';
import { getObjectInfo } from 'lightning/uiObjectInfoApi';
import ACCOUNT_OBJECT from '@salesforce/schema/Account';
import CITY_FIELD from '@salesforce/schema/Account.Type';
import getArea from '@salesforce/apex/PJPServiceImpl.getArea';
import getuser from '@salesforce/apex/PJPServiceImpl.getUser';
import getCity from '@salesforce/apex/PJPServiceImpl.getCity';
import getProfile from '@salesforce/apex/PJPServiceImpl.getProfile';
import getUserid from '@salesforce/apex/PJPServiceImpl.getUserId';
import getAreaAll from "@salesforce/apex/PJPServiceImpl.getAreaAll";
import getUsername from "@salesforce/apex/PJPServiceImpl.getUsername";
import getSubzone from "@salesforce/apex/PJPServiceImpl.getSubzone";
import getcityOnArea from "@salesforce/apex/PJPServiceImpl.getcityOnArea";
import getCityforGM from "@salesforce/apex/PJPServiceImpl.getCityforGM";
import getAreaforGM from "@salesforce/apex/PJPServiceImpl.getAreaforGM";
import getMonth from "@salesforce/apex/PJPServiceImpl.getMonth";
import getMonthdetails from "@salesforce/apex/PJPServiceImpl.getMonthdetails";
import getMonthmap from "@salesforce/apex/PJPServiceImpl.getMonthmap";
import getUserforGM from "@salesforce/apex/PJPServiceImpl.getUserforGM";
import deleteDetails from "@salesforce/apex/PJPServiceImpl.getdeleteDetails";
import getApprovalData from '@salesforce/apex/ApprovalComponentController.getApprovalData';
import getBdmuser from "@salesforce/apex/PJPServiceImpl.getBdmuser";
// import getrkmuser from "@salesforce/apex/PJPServiceImpl.getrkmuser";
import getZone from "@salesforce/apex/PJPServiceImpl.getZone";
import rkmCity from "@salesforce/apex/PJPServiceImpl.rkmCity";
import rkmArea from "@salesforce/apex/PJPServiceImpl.rkmArea";
import getpjp from "@salesforce/apex/PJPServiceImpl.getpjp";
import getCurrentUser from "@salesforce/apex/PJPServiceImpl.getCurrentUser";
import getUserbyId from "@salesforce/apex/PJPServiceImpl.getUserbyId";
import { CurrentPageReference, NavigationMixin } from 'lightning/navigation';
import getMOnthbyId from "@salesforce/apex/PJPServiceImpl.getMOnthbyId";
import submitForApproval from "@salesforce/apex/PJPServiceImpl.submitForApproval";
import approvePjp from "@salesforce/apex/PJPServiceImpl.approvePjp";
import rejectPjp from "@salesforce/apex/PJPServiceImpl.rejectPjp";
import getMonthOnUser from "@salesforce/apex/PJPServiceImpl.getMonthOnUser";
import getSubclassFromApex from "@salesforce/apex/PJPServiceImpl.getSubclassFromApex";
import getRkamUser from "@salesforce/apex/PJPServiceImpl.getRkamUser";
import getpjpUserId from "@salesforce/apex/PJPServiceImpl.getpjpUserId";
import getProfileMetadata from "@salesforce/apex/PJPServiceImpl.getProfileMetadata";
import getNkamUser from "@salesforce/apex/PJPServiceImpl.getNkamUser";
// import getEvents from "@salesforce/apex/PJPServiceImpl.getEvents";

// import addEvent from "@salesforce/apex/PJPServiceImpl.addEvent";
...
export default class pJP extends NavigationMixin(LightningElement) {
  ...
  @wire(getAccountData, { filter1: '$filter1', filter2: '$filter2', filter3: '$filter1', subclass: '$filter4' }) 
  acoountListwiredContacts({ error, data }) {
...
//let data = await getMonth();
  ...
  handleChangeFilter2(event) {
    ...
    console.log('filter2=> Area'+this.filter2);
    getcityOnArea({ areaId: this.filter2 })
      .then(data => {
        console.log('cityOnArea ',data);
        this.filter1 = data.City__c;
      }).catch(err=>{
        this.filter1 = '';
        console.log('ERR 123',JSON.stringify(err));
      })
      this.spinner = false;
  }
      ...
      .then(bdmuser => {
        ...
        for (let i = 0; i < bdmuser.length; i++) {
          if(bdmuser[i].User__c){
            ...
            console.log('BDM user 1122'+bdmuser[i].User__r.Name)
           this.user = [...this.user, { label: bdmuser[i].User__r.Name, value: bdmuser[i].User__r.Id }];
           console.log(JSON.stringify(this.user)+'getbdm user')
          }
